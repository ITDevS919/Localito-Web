...
export default function TermsBusinessesPage() {
  return (
          ...
          <div className="prose prose-sm md:prose-base max-w-none prose-headings:font-heading prose-headings:text-foreground prose-a:text-primary">
            ...
            <section className="space-y-4">
              <p className="text-sm leading-relaxed text-muted-foreground">
                ...
                a business. By registering an account, listing products, or
                accepting orders via the Platform, you (&quot;Business&quot;, &quot;you&quot;)
            ...
            <section className="space-y-3 mt-8">
              ...
              <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-1">
                <li>
                  You must be a UK-based independent business, aged 18 or over,
