...
export default function BusinessPostsPage() {
  ...
  const fetchPosts = async () => {
    try {
      const res = await fetch(`${API_BASE_URL}/business/posts`, {
        credentials: "include",
      });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const url = editingPost
        ? `${API_BASE_URL}/business/posts/${editingPost.id}`
        : `${API_BASE_URL}/business/posts`;
  ...
  const handleDelete = async (postId: string) => {
    ...
    try {
      const res = await fetch(`${API_BASE_URL}/business/posts/${postId}`, {
        method: "DELETE",
        credentials: "include",
      });
