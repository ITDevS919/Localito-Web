...
import { LayoutDashboard, Package, Users, UserCircle, LogOut, Shield, Tag, MessageCircle, ShoppingBag, FolderTree, Star, Settings, CreditCard, Menu } from "lucide-react";
...
export function AdminDashboardLayout({ children }: AdminDashboardLayoutProps) {
  ...
  const navItems = [
    ...
    { href: "/admin/payout-verifications", label: "Payout Verifications", icon: CreditCard },
  ...
  const getPageTitle = () => {
    ...
    if (location === "/admin/payout-verifications") return "Payout Verifications";
